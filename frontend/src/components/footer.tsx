                    ...
                    <div className="row popped rounded">
                        ...
                        <div className="col-lg-3">
                         ...
                         <div className="col-lg-3">
                            ...
                            <p className="br"></p>
                            <ul className='ft-list m-0 p-0'>
                                <Link href={"https://github.com/dinxsh"} target='_blank'>
                                    <li><Image src={"/media/nfts/1.jpeg"} alt="Dinesh" height={24} width={24} className='me-2 rounded-circle' />Dinesh</li>
                                </Link>
                                <Link href={"https://github.com/"} target='_blank'>
                                    <li><Image src={"/media/nfts/1.jpeg"} alt="Raveesh" height={24} width={24} className='me-2 rounded-circle' />Raveesh</li>
                                </Link>
                                <Link href={"https://github.com/aaronvern"} target='_blank'>
                                    <li><Image src={"/media/nfts/10.jpeg"} alt="Aaron Vernekar" height={24} width={24} className='me-2 rounded-circle' />Aaron Vernekar</li>
                                </Link>
                                <Link href={"https://github.com/"} target='_blank'>
                                    <li><Image src={"/media/nfts/1.jpeg"} alt="Rayvego" height={24} width={24} className='me-2 rounded-circle' />Rayvego</li>
                                </Link>
                            </ul>
                        </div> 
